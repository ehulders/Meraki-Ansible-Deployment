...
The first two tasks read the files '(addressing.yaml)[https://github.com/sttrayno/Meraki-Ansible-Deployment/playbooks/addressing.yaml]' and (devices.yaml)[https://github.com/sttrayno/Meraki-Ansible-Deployment/playbooks/devices.yaml] and store the contents in variables to be used in the later tasks. Have a look at both files in the /playbooks folder of this repository you'll see how they are laid out.
